...
AMZN_CIK = "1018724"
EDGAR_URL = f"https://data.sec.gov/submissions/CIK000{AMZN_CIK}.json"

CSV_FILE = "amzn_insider_trades.csv"
...
def fetch_form4_filings():
    ...
    for i, form_type in enumerate(forms):
        if form_type == "4":
            ...
            doc = primary_docs[i]
            filing_url = f"https://www.sec.gov/Archives/edgar/data/{AMZN_CIK}/{acc_no_stripped}/{doc}"
...
def send_email(csv_path):
    ...
    subject = "AMZN Insider Trades Report (FORM 4)"
    body = "Attached is the AMZN insider trades report for ALL Form 4 filings."
...
def main_task():
    print("Processing all Form 4 filings for AMZN...")
