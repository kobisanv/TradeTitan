#!/usr/bin/env python3
"""AMZN Stock Data Fetcher with Sentiment Analysis"""
...
class AMZNFetcher:
    def __init__(self):
        ...
        self.timeframes = {
            "1h": ("2y", "AMZN_1h.csv"),    # 2 years of hourly data
            "1d": ("5y", "AMZN_1d.csv"),    # 5 years of daily data
            "1wk": ("10y", "AMZN_1wk.csv"), # 10 years of weekly data
            "1mo": ("20y", "AMZN_1mo.csv"), # 20 years of monthly data
        }
    ...
    def fetch_news_sentiment(self):
        ...
        queries = [self.symbol, "AMZN STOCK", "Amazon", "Amazon.com Inc"]
        news_data = []
