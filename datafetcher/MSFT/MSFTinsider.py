...
MSFT_CIK = "0789019"
EDGAR_URL = f"https://data.sec.gov/submissions/CIK000{MSFT_CIK}.json"
...
def fetch_form4_filings():
    print("🔍 Fetching EDGAR JSON for MSFT...")
    ...
    for i, form_type in enumerate(forms):
        if form_type == "4":
            ...
            doc = primary_docs[i]
            filing_url = f"https://www.sec.gov/Archives/edgar/data/{MSFT_CIK}/{acc_no_stripped}/{doc}"
...
def send_email(csv_path):
    ...
    subject = "MSFT Insider Trades Report (FORM 4)"
    body = "Attached is the MSFT insider trades report for ALL Form 4 filings."
...
def main_task():
    print("Processing all Form 4 filings for MSFT...")
