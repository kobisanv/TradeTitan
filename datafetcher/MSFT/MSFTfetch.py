#!/usr/bin/env python3
"""MSFT Stock Data Fetcher with Sentiment Analysis"""
...
class MSFTFetcher:
    def __init__(self):
        ...
        self.timeframes = {
            "1h": ("2y", "MSFT_1h.csv"),    # 2 years of hourly data
            "1d": ("5y", "MSFT_1d.csv"),    # 5 years of daily data
            "1wk": ("10y", "MSFT_1wk.csv"), # 10 years of weekly data
            "1mo": ("20y", "MSFT_1mo.csv"), # 20 years of monthly data
        }
    ...
    def fetch_news_sentiment(self):
        ...
        queries = [self.symbol, "Microsoft", "MSFT STOCK", "Microsoft Corporation"]
        news_data = []
