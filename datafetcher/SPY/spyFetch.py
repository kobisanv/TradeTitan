#!/usr/bin/env python3
"""SPY ETF Data Fetcher with Sentiment Analysis"""
...
class SPYFetcher:
    ...
    def calculate_technical_indicators(self, data):
        """Calculate technical indicators for the ETF data."""
    ...
    def fetch_and_save_data(self, interval, period, filename, retries=3):
        """Fetch ETF data and save to CSV with technical indicators."""
    ...
    def fetch_news_sentiment(self):
        ...
        queries = [self.symbol, "SPDR S&P 500", "SPY ETF", "S&P 500 ETF"]
        news_data = []
        ...
        if news_data:
            ...
            filename = f"SPDR S&P 500_news_sentiment.csv"
